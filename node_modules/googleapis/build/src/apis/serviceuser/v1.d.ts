...
export declare namespace serviceuser_v1 {
     ...
     */
    interface Schema$ListEnabledServicesResponse {
        /**
     ...
     * Management.
     */
    interface Schema$PublishedService {
        /**
     ...
     */
    interface Schema$SearchServicesResponse {
        /**
    ...
    class Resource$Projects$Services {
         ...
         */
        disable(params?: Params$Resource$Projects$Services$Disable, options?: MethodOptions): AxiosPromise<Schema$Operation>;
        disable(params: Params$Resource$Projects$Services$Disable, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        disable(params: Params$Resource$Projects$Services$Disable, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @return {object} Request object
         */
        enable(params?: Params$Resource$Projects$Services$Enable, options?: MethodOptions): AxiosPromise<Schema$Operation>;
        enable(params: Params$Resource$Projects$Services$Enable, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        enable(params: Params$Resource$Projects$Services$Enable, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Projects$Services$List, options?: MethodOptions): AxiosPromise<Schema$ListEnabledServicesResponse>;
        list(params: Params$Resource$Projects$Services$List, options: MethodOptions | BodyResponseCallback<Schema$ListEnabledServicesResponse>, callback: BodyResponseCallback<Schema$ListEnabledServicesResponse>): void;
        list(params: Params$Resource$Projects$Services$List, callback: BodyResponseCallback<Schema$ListEnabledServicesResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListEnabledServicesResponse>): void;
    }
    interface Params$Resource$Projects$Services$Disable {
        /**
    ...
    interface Params$Resource$Projects$Services$Enable {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Services$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Services {
         ...
         * @return {object} Request object
         */
        search(params?: Params$Resource$Services$Search, options?: MethodOptions): AxiosPromise<Schema$SearchServicesResponse>;
        search(params: Params$Resource$Services$Search, options: MethodOptions | BodyResponseCallback<Schema$SearchServicesResponse>, callback: BodyResponseCallback<Schema$SearchServicesResponse>): void;
        search(params: Params$Resource$Services$Search, callback: BodyResponseCallback<Schema$SearchServicesResponse>): void;
        search(callback: BodyResponseCallback<Schema$SearchServicesResponse>): void;
    }
    interface Params$Resource$Services$Search {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

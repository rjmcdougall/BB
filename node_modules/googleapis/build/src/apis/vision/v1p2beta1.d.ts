...
export declare namespace vision_v1p2beta1 {
    ...
    class Resource$Files {
         ...
         */
        asyncBatchAnnotate(params?: Params$Resource$Files$Asyncbatchannotate, options?: MethodOptions): AxiosPromise<Schema$Operation>;
    ...
    interface Params$Resource$Files$Asyncbatchannotate {
        /**
    ...
    class Resource$Images {
         ...
         * @return {object} Request object
         */
        annotate(params?: Params$Resource$Images$Annotate, options?: MethodOptions): AxiosPromise<Schema$GoogleCloudVisionV1p2beta1BatchAnnotateImagesResponse>;

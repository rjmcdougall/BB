...
export declare namespace vision_v1 {
    ...
    class Resource$Images {
         ...
         */
        annotate(params?: Params$Resource$Images$Annotate, options?: MethodOptions): AxiosPromise<Schema$BatchAnnotateImagesResponse>;
    ...
    interface Params$Resource$Images$Annotate {
        /**
    ...
    class Resource$Locations$Operations {
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Locations$Operations$Get, options?: MethodOptions): AxiosPromise<Schema$Operation>;
    ...
    interface Params$Resource$Locations$Operations$Get {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

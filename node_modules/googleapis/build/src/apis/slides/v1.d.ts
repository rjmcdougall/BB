...
export declare namespace slides_v1 {
    ...
    class Resource$Presentations {
         ...
         */
        batchUpdate(params?: Params$Resource$Presentations$Batchupdate, options?: MethodOptions): AxiosPromise<Schema$BatchUpdatePresentationResponse>;
         ...
         * @return {object} Request object
         */
        create(params?: Params$Resource$Presentations$Create, options?: MethodOptions): AxiosPromise<Schema$Presentation>;
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Presentations$Get, options?: MethodOptions): AxiosPromise<Schema$Presentation>;
    ...
    interface Params$Resource$Presentations$Batchupdate {
        /**
    ...
    interface Params$Resource$Presentations$Create {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Presentations$Get {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Presentations$Pages {
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Presentations$Pages$Get, options?: MethodOptions): AxiosPromise<Schema$Page>;
         ...
         * @return {object} Request object
         */
        getThumbnail(params?: Params$Resource$Presentations$Pages$Getthumbnail, options?: MethodOptions): AxiosPromise<Schema$Thumbnail>;
    ...
    interface Params$Resource$Presentations$Pages$Get {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Presentations$Pages$Getthumbnail {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

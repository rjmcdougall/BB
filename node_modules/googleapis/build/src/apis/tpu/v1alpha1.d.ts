...
export declare namespace tpu_v1alpha1 {
     ...
     */
    interface Schema$ResetNodeRequest {
    }
    /**
    ...
    class Resource$Projects$Locations$Nodes {
         ...
         * @return {object} Request object
         */
        reset(params?: Params$Resource$Projects$Locations$Nodes$Reset, options?: MethodOptions): AxiosPromise<Schema$Operation>;
        reset(params: Params$Resource$Projects$Locations$Nodes$Reset, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        reset(params: Params$Resource$Projects$Locations$Nodes$Reset, callback: BodyResponseCallback<Schema$Operation>): void;
    ...
    interface Params$Resource$Projects$Locations$Nodes$Reset {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

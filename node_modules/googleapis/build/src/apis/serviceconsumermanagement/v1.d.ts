...
export declare namespace serviceconsumermanagement_v1 {
     ...
     */
    interface Schema$AuthorizationRule {
        /**
    ...
    class Resource$Operations {
         ...
         * @return {object} Request object
         */
        delete(params?: Params$Resource$Operations$Delete, options?: MethodOptions): AxiosPromise<Schema$Empty>;
    ...
    class Resource$Services {
         ...
         * @return {object} Request object
         */
        search(params?: Params$Resource$Services$Search, options?: MethodOptions): AxiosPromise<Schema$SearchTenancyUnitsResponse>;
    ...
    class Resource$Services$Tenancyunits {
         ...
         * @return {object} Request object
         */
        addProject(params?: Params$Resource$Services$Tenancyunits$Addproject, options?: MethodOptions): AxiosPromise<Schema$Operation>;
         ...
         * @return {object} Request object
         */
        create(params?: Params$Resource$Services$Tenancyunits$Create, options?: MethodOptions): AxiosPromise<Schema$TenancyUnit>;
         ...
         * @return {object} Request object
         */
        delete(params?: Params$Resource$Services$Tenancyunits$Delete, options?: MethodOptions): AxiosPromise<Schema$Operation>;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Services$Tenancyunits$List, options?: MethodOptions): AxiosPromise<Schema$ListTenancyUnitsResponse>;
         ...
         * @return {object} Request object
         */
        removeProject(params?: Params$Resource$Services$Tenancyunits$Removeproject, options?: MethodOptions): AxiosPromise<Schema$Operation>;
    ...
    interface Params$Resource$Services$Tenancyunits$Addproject {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Services$Tenancyunits$Create {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Services$Tenancyunits$Delete {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Services$Tenancyunits$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Services$Tenancyunits$Removeproject {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

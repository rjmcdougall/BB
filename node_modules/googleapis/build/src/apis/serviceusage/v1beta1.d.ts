...
export declare namespace serviceusage_v1beta1 {
    ...
    class Resource$Services {
         ...
         * @return {object} Request object
         */
        batchEnable(params?: Params$Resource$Services$Batchenable, options?: MethodOptions): AxiosPromise<Schema$Operation>;
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Services$Get, options?: MethodOptions): AxiosPromise<Schema$Service>;
    ...
    interface Params$Resource$Services$Batchenable {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

...
export declare namespace cloudiot_v1 {
    ...
    class Resource$Projects$Locations$Groups$Devices {
        root: Cloudiot;
        constructor(root: Cloudiot);
        getRoot(): Cloudiot;
        /**
         ...
         */
        list(params?: Params$Resource$Projects$Locations$Groups$Devices$List, options?: MethodOptions): AxiosPromise<Schema$ListDevicesResponse>;
        list(params: Params$Resource$Projects$Locations$Groups$Devices$List, options: MethodOptions | BodyResponseCallback<Schema$ListDevicesResponse>, callback: BodyResponseCallback<Schema$ListDevicesResponse>): void;
        list(params: Params$Resource$Projects$Locations$Groups$Devices$List, callback: BodyResponseCallback<Schema$ListDevicesResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListDevicesResponse>): void;
    }
    interface Params$Resource$Projects$Locations$Groups$Devices$List {
        /**

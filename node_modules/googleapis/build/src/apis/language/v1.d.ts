...
export declare namespace language_v1 {
    ...
    class Resource$Documents {
         ...
         */
        analyzeEntities(params?: Params$Resource$Documents$Analyzeentities, options?: MethodOptions): AxiosPromise<Schema$AnalyzeEntitiesResponse>;
         ...
         * @return {object} Request object
         */
        analyzeEntitySentiment(params?: Params$Resource$Documents$Analyzeentitysentiment, options?: MethodOptions): AxiosPromise<Schema$AnalyzeEntitySentimentResponse>;
         ...
         * @return {object} Request object
         */
        analyzeSentiment(params?: Params$Resource$Documents$Analyzesentiment, options?: MethodOptions): AxiosPromise<Schema$AnalyzeSentimentResponse>;
         ...
         * @return {object} Request object
         */
        analyzeSyntax(params?: Params$Resource$Documents$Analyzesyntax, options?: MethodOptions): AxiosPromise<Schema$AnalyzeSyntaxResponse>;
         ...
         * @return {object} Request object
         */
        annotateText(params?: Params$Resource$Documents$Annotatetext, options?: MethodOptions): AxiosPromise<Schema$AnnotateTextResponse>;
         ...
         * @return {object} Request object
         */
        classifyText(params?: Params$Resource$Documents$Classifytext, options?: MethodOptions): AxiosPromise<Schema$ClassifyTextResponse>;
    ...
    interface Params$Resource$Documents$Analyzeentities {
        /**
    ...
    interface Params$Resource$Documents$Analyzesyntax {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Documents$Annotatetext {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Documents$Classifytext {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
